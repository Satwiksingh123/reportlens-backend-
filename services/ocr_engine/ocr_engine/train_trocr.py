...
def main() -> None:
    ...
    # Neutral length handling. An earlier length_penalty=1.4 rewarded longer sequences and
    # got baked into the saved model, which then appended garbage after the real text
    # ("0.3" -> "0.333533833G"). Keep it neutral and let the model stop at EOS.
